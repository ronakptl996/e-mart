            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                  ...
                  {Object.keys(variants).includes("black") &&
                    Object.keys(variants["black"]).includes(size) && (
                      <button
                        ...
                        className={`border-2 border-gray-300 bg-black rounded-full w-6 h-6 focus:outline-none ${
                  ...
                  {Object.keys(variants).includes("green") &&
                    Object.keys(variants["green"]).includes(size) && (
                      <button
                        ...
                        className={`border-2 border-gray-300 bg-green-700 rounded-full w-6 h-6 focus:outline-none ${
                  ...
                  {Object.keys(variants).includes("yellow") &&
                    Object.keys(variants["yellow"]).includes(size) && (
                      <button
                        ...
                        className={`border-2 border-gray-300 bg-yellow-700 rounded-full w-6 h-6 focus:outline-none ${
                          color === "yellow"
                            ? "border-black"
                            : "border-gray-300"
                        }`}
                  ...
                  {Object.keys(variants).includes("gray") &&
                    Object.keys(variants["gray"]).includes(size) && (
                      <button
                        ...
                        className={`border-2 bg-gray-700 rounded-full w-6 h-6 focus:outline-none ${
              ...
              <div className="flex">
                ...
                <button
                  ...
                  className="disabled:bg-indigo-300 flex text-sm ml-10 md:text-lg text-white bg-indigo-500 border-0 p-1 md:px-6 focus:outline-none hover:bg-indigo-600 rounded"
                >
                  Buy Now
                </button>
                <button
                  ...
                  disabled={product.availableQty <= 0}
                  className="disabled:bg-indigo-300 flex text-sm md:text-lg ml-4 text-white bg-indigo-500 border-0 p-1 md:px-6 focus:outline-none hover:bg-indigo-600 rounded"
                >
                  Add to Cart
                </button>

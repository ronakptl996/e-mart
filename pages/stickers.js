        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap -m-4 justify-center">
            {Object.keys(products).length == 0 && (
              <p>
                Product is out of stoke. New Stoke Comming Soon. Stay Tuned!
              </p>
            )}
                    ...
                    <div className="mt-4 md:text-left text-center">
                      ...
                      <div className="mt-1">
                        ...
                        {products[item].color.includes("gray") && (
                          <button className="border-2 border-gray-300 bg-gray-600 rounded-full w-6 h-6 focus:outline-none"></button>
                        )}
